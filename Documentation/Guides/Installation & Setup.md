...
- [Changelog](http://www.hockeyapp.net/help/sdk/ios/5.1.3/docs/docs/Changelog.html)
...
Our documentation can be found on [HockeyApp](http://hockeyapp.net/help/sdk/ios/5.1.3/index.html).
...
### iTunes Connect rejection
  ...
  - `de.bitstadium.HockeySDK-iOS-5.1.3.docset`
